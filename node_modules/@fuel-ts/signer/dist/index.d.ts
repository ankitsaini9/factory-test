...
declare class Signer {
     ...
     */
    static recoverPublicKey(data: BytesLike, signature: BytesLike): any;
    /**
     ...
     */
    static recoverAddress(data: BytesLike, signature: BytesLike): string;
    /**
