import { Provider, TransactionRequestLike, TransactionRequest, CoinQuantityLike, Coin, CoinQuantity, TransactionResponse, CallResult } from '@fuel-ts/providers';
...
declare class Wallet extends AbstractWallet {
     ...
     */
    getCoinsToSpend(quantities: CoinQuantityLike[]): Promise<Coin[]>;
    /**
     ...
     */
    getBalance(assetId?: BytesLike): Promise<bigint>;
    /**
     * Gets balances.
     */
    ...
    assetId?: BytesLike, 
    /** Tx Params */
    txParams?: Pick<TransactionRequestLike, 'gasLimit' | 'gasPrice' | 'bytePrice' | 'maturity'>): Promise<TransactionResponse>;
    /**
...
declare const generateTestWallet: (provider: Provider, quantities?: CoinQuantityLike[] | undefined) => Promise<Wallet>;
